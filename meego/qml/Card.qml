...
Item {
    ...
    property string artwork: (typeof tarockEngine === "undefined")
    ...
    property bool isTarock: suitIndex === 4
    property bool isRed: suitIndex === 0 || suitIndex === 1
    property color inkColor: isTarock ? "#2f4f7f" : (isRed ? "#a01b1b" : "#1c1c1c")
