...
Item {
    ...
    property bool isActor: engine !== null && engine.actor === seat
    property bool sittingOut: info.isSittingOut === true
    property string party: info.partnerState === undefined ? "unknown" : info.partnerState
