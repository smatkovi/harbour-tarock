...
Item {
    ...
    property variant trap: null
    property string passedText: ""
    property variant attached: null

    property variant step: learn === null ? null : learn.lessonStep
    property bool active: learn !== null && learn.lessonActive === true
