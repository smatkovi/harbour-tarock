...
Item {
    ...
    property var openAnchor: null
    property var openTerm: null

    readonly property int level: learn === null || learn.level === undefined ? 0 : learn.level
    readonly property var explanation: learn === null ? null : learn.explanation
    readonly property bool expanded: learn !== null && learn.panelOpen === true
