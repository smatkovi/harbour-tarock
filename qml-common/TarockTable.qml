...
Item {
    ...
    // der vierte.
    readonly property int lastSeat: table.players === 5 ? 4
    ...
    readonly property var strawmen: engine.strawmen
    readonly property var strawmenTaken: engine.strawmenTaken
    readonly property bool hasStrawmen: strawmen && strawmen.length > 0
    ...
    SeatPanel {
        ...
        readonly property int acrossSeat: table.players === 2 ? 1 : 2
