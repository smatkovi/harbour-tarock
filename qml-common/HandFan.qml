...
Item {
    ...
    readonly property int count: cards ? cards.length : 0
    ...
    readonly property real cardHeight: cardWidth * cardRatio
    ...
    Repeater {
        ...
        Item {
            id: slot
            readonly property bool chosen: fan.chosenIds[modelData.id] === true
            width: fan.cardWidth
